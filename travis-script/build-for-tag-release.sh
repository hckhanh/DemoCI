...
if [ -n "$TRAVIS_TAG" ]; then
	...
	SERVER_RELEASE_PATH=$TRAVIS_BUILD_DIR/release-$TRAVIS_TAG/server
	CLIENT_RELEASE_PATH=$TRAVIS_BUILD_DIR/release-$TRAVIS_TAG/client
	RELESE_APK_ANDROID_APP1=$ANDROID_APP1_MODULE_NAME/$RELEASE_PATH_FILE/$ANDROID_APP1_MODULE_NAME-$BUILD_TYPE.apk
	RELESE_APK_ANDROID_APP2=$ANDROID_APP2_MODULE_NAME/$RELEASE_PATH_FILE/$ANDROID_APP2_MODULE_NAME-$BUILD_TYPE.apk
